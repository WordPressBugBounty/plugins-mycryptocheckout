...
Crypto payment gateway for WooCommerce and Easy Digital Downloads. Receive coins, including Bitcoin, directly into the wallet of your choice.
...
* Fix fatal error on settings page when there are no unmatched payments.

= 2.171 =

* Version bump to not confuse WP (2.170 = 2.17)

= 2.170 =

* New: Bundled full French, German, Italian, Lithuanian, Portuguese, Spanish, and Swedish translations across the customer checkout and plugin administration interface, including regional WordPress locale packages.
* Tweak: Modern checkout UI is now default for new installs. Those using classic will have to manually change their checkout UI to modern.
* Fix: Localized previously hardcoded classic and modern checkout, payment status, security notice, email, order detail, WooCommerce block, and clipboard messages.
* Update: NPM dependencies.

= 2.169 20260606 =

* New: Added "unmatched payments" tab that appears if there are unmatched payments for your account.
...
* Fix: use intval() to display the payments left value in the account table.
...
* web3 to v4.16.0
* solana web3.js to v1.98.4
* spl-token to v0.4.13
* bignumber.js to v9.3.1
* @wordpress/scripts to v27.9.0
* qrcode to v1.5.4
* @babel to v7.28.3
* Update: EVM - MetaMask gas for native ETH transfers.
* Update: API - MetaMask gas calcs for ETH and Base.
...
Fix: Tell IOS Safari to not auto-format the amount field on the checkout page.
...
* Fix: QRcode for USDT ERC20 currency was giving the incorrect amount of decimals.
...
* Fix: BNB gas calculations
* Fix: Updated ETH gas calculations to EIP-1559
* Fix: Updated Matic gas calculations to EIP-1559
* New currency: LUFFY
...
* Version bump because Wordpress plugin tag system failed. Fixed critical error.
